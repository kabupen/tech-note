...
pubDate: 2024-06-15
categories: ["統計"]
description: "ガンマ関数の基本から始め、ガンマ分布の定義・性質・利用例、さらにその特殊形として位置づけられるカイ二乗分布との関係までを整理します。"
---
...
で表され、$\alpha$ を形状母数、$\beta$ を尺度母数と呼びます^[参考書によって定義はまちまちなので気をつけてください。手元の「自然科学の統計学」「現代数理統計学」「現代数理統計学の基礎」「パターン認識と機械学習(上)」では全て定義が異なっていました。]。
