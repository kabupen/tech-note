---
title: "ComfyUI入門：WSLで構築してFlux.2 Devテンプレを動かす"
pubDate: 2026/01/24
...
description: "ComfyUIの基本概念と、Windows上のWSLでのセットアップ手順をまとめる。Flux.2 Devテンプレートを使った初回モデル導入と簡単な画像編集、WebUIから移行する際の所感も記録。"
---
